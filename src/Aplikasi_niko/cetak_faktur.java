...
+"'";
 ResultSet rs = statement.executeQuery(sql);
            if (rs.next()){
              jTextArea1.setText("             *** FAKTUR PEMBAYARAN SPP ***"+
                                 "\n     Jl.KH.MUSA Kec.TARUMAJAYA Kab.Bekasi 17215"+
                                 "\n                Telp.(021)8901348"+
                                 "\n================================================"+
                                 "\n=============TRANSAKSI PEMABAYARAN SPP=========="+ "\n" 
                                      + "No Transaksi      : " + rs.getString(1)+ "\n" 
                                      + "No faktur         : " + rs.getString(2)+ "\n" 
                                      + "Tanggal           : " + rs.getString(3)+ "\n"
                                      + "Jam               : " + rs.getString(4)+ "\n"
                                      + "Nama Siswa        : " + rs.getString(6) +"\n"
                                      + "Kode SPP          : " + rs.getString(7) +"\n"
                                      + "Nama Siswa        : " + rs.getString(8) +"\n"
                                      + "Kelas\t           : " + rs.getString(9) +"\n"
                                      + "Bulan\t           : " + rs.getString(10) +"\n"
                                      + "Tahun\t           : " + rs.getString(11) +"\n"
                                      + "Nominal\t         : " + rs.getString(12) +"\n"
                                      +
                                
                                 "\n================================================"+
                                 "\n       Terimasih Telah Membayar SPP Sekolah,"+
                                 "\n        Demi Kenyamanan Wali Murid Dimohon."+
                                 "\n     Mengecek Dulu Kwintasi Yang Sudah Di Terima."+
                                 "\n");
              }else{
